package com.jinosoft.chap03responselecturesource.section01.response;
...
public class ResponseTest extends HttpServlet {
  /* 기본적인 요청-응답 순서
   * 1. 요청ㅇㄹ 받아 처리한다 => 파라미터 꺼내기(req.getParameter())
   * 2. 비즈니스 로직을 처리한다 => DB 접속 및 CRUD 수행
   * 3. 응답을 처리한다
   *  => resp를 이용해서 결과 웹을 만들고(동적 웹, HTML 코드)
   *     스트림을 통해서 클라이언트에게 출력한다.
   * */
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    sb.append("<html>")
        ...
        .append("</head>")
        .append("<body>")
        .append("<h1>안녕 Servlet response</h1>"); // h1 == 하이라이트
